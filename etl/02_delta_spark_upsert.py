...
spark = (SparkSession.builder.appName("DeltaDatalake")
...
logger.info("Reduce to 50 cases and execute internal updates for residence city")
...
logger.info("Generate symlink manifest...")
